...
class ColumnLevelKnowledgePropagator:
    ...
    def update_undocumented_columns_with_prior_knowledge(
        ...
        for column in undocumented_columns:
            original_knowledge = ColumnLevelKnowledgePropagator._get_original_knowledge(node, column)
            ...
            prior_knowledge: ColumnLevelKnowledge = get_prior_knowledge(knowledge, column_without_prefix)
